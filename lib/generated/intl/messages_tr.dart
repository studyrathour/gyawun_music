...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "Battery_Optimisation_message": MessageLookupByLibrary.simpleMessage(
      "Songify un düzgün çalışması için pil optimizasyonunu devre dışı bırakmak için buraya tıklayın",
    ),
    ...
    "Donate_Message": MessageLookupByLibrary.simpleMessage(
      "Songify un geliştirilmesini destekleyin",
    ),
    ...
    "Search_Songify": MessageLookupByLibrary.simpleMessage("Songify Ara"),
